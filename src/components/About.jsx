...
function About() {
  return (
    <div>
        <Grid container spacing={15} className="about-container">
      ...
      <div className="bio">
        ...
        coding on the side through FreeCodeCamp, Khan Academy, and YouTube. I discovered that programming offered the perfect blend of 
